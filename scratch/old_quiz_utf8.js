    ...
    if (isLoading) {
        return (
            <div style={{...styles.container, justifyContent: 'center', alignItems: 'center'}}>
                <div style={{ fontSize: '3rem', animation: 'spin 2s linear infinite' }}>竢ｳ</div>
                <p style={{ marginTop: '20px', color: '#94a3b8', textAlign: 'center', maxWidth: '80%' }}>
                    笘・ｸ・Prﾃｩparation du quiz...<br/>
                    <small>(Le serveur IA dﾃｩmarre, merci de patienter quelques secondes)</small>
                </p>
        ...
        <div ref={containerRef} style={styles.container}>
            ...
            <div style={{ marginBottom: "20px" }}>
                <button onClick={togglePause} style={isPlaying ? styles.pauseBtn : styles.startBtn}>
                    {isPlaying ? "竢ｸ Pause" : (question ? "笆ｶ・・Resume" : "笆ｶ・・Start")}
                </button>
            </div>
            ...
            */}
            ...
            {result && (
                ...
                >
                    ...
                    <h3 style={{ margin: "10px 0" }}>{result.correct ? "笨・Correct" : "笨・Wrong"}</h3>
